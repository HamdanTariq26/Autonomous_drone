...
bool tello_autonomy_msgs__msg__segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tello_autonomy_msgs.msg._segment.Segment", full_classname_dest, 40) == 0);
  }
  tello_autonomy_msgs__msg__Segment * ros_message = _ros_message;
  {  // header
...
PyObject * tello_autonomy_msgs__msg__segment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tello_autonomy_msgs.msg._segment");
