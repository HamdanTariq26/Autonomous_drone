...
tello_autonomy_msgs__srv__NbvPlan_Request__init(tello_autonomy_msgs__srv__NbvPlan_Request * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    tello_autonomy_msgs__srv__NbvPlan_Request__fini(msg);
    return false;
  }
  return true;
}
...
tello_autonomy_msgs__srv__NbvPlan_Request__create()
{
  ...
  tello_autonomy_msgs__srv__NbvPlan_Request * msg = (tello_autonomy_msgs__srv__NbvPlan_Request *)allocator.allocate(sizeof(tello_autonomy_msgs__srv__NbvPlan_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tello_autonomy_msgs__srv__NbvPlan_Request));
  bool success = tello_autonomy_msgs__srv__NbvPlan_Request__init(msg);
  if (!success) {
...
tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__init(tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tello_autonomy_msgs__srv__NbvPlan_Request * data = NULL;

  if (size) {
    data = (tello_autonomy_msgs__srv__NbvPlan_Request *)allocator.zero_allocate(size, sizeof(tello_autonomy_msgs__srv__NbvPlan_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tello_autonomy_msgs__srv__NbvPlan_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tello_autonomy_msgs__srv__NbvPlan_Request__fini(&data[i - 1]);
      }
...
tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__fini(tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tello_autonomy_msgs__srv__NbvPlan_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * array = (tello_autonomy_msgs__srv__NbvPlan_Request__Sequence *)allocator.allocate(sizeof(tello_autonomy_msgs__srv__NbvPlan_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__init(array, size);
  if (!success) {
...
tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__destroy(tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tello_autonomy_msgs__srv__NbvPlan_Request__Sequence__are_equal(const tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * lhs, const tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tello_autonomy_msgs__srv__NbvPlan_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tello_autonomy_msgs__srv__NbvPlan_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tello_autonomy_msgs__srv__NbvPlan_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tello_autonomy_msgs__srv__NbvPlan_Request * data =
      (tello_autonomy_msgs__srv__NbvPlan_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tello_autonomy_msgs__srv__NbvPlan_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tello_autonomy_msgs__srv__NbvPlan_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tello_autonomy_msgs__srv__NbvPlan_Request__copy(
...
tello_autonomy_msgs__srv__NbvPlan_Response__init(tello_autonomy_msgs__srv__NbvPlan_Response * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__Sequence__init(&msg->path, 0)) {
    tello_autonomy_msgs__srv__NbvPlan_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tello_autonomy_msgs__srv__NbvPlan_Response * msg = (tello_autonomy_msgs__srv__NbvPlan_Response *)allocator.allocate(sizeof(tello_autonomy_msgs__srv__NbvPlan_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tello_autonomy_msgs__srv__NbvPlan_Response));
  bool success = tello_autonomy_msgs__srv__NbvPlan_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__init(tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tello_autonomy_msgs__srv__NbvPlan_Response * data = NULL;

  if (size) {
    data = (tello_autonomy_msgs__srv__NbvPlan_Response *)allocator.zero_allocate(size, sizeof(tello_autonomy_msgs__srv__NbvPlan_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tello_autonomy_msgs__srv__NbvPlan_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tello_autonomy_msgs__srv__NbvPlan_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__fini(tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tello_autonomy_msgs__srv__NbvPlan_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * array = (tello_autonomy_msgs__srv__NbvPlan_Response__Sequence *)allocator.allocate(sizeof(tello_autonomy_msgs__srv__NbvPlan_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__destroy(tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tello_autonomy_msgs__srv__NbvPlan_Response__Sequence__are_equal(const tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * lhs, const tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tello_autonomy_msgs__srv__NbvPlan_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tello_autonomy_msgs__srv__NbvPlan_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tello_autonomy_msgs__srv__NbvPlan_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tello_autonomy_msgs__srv__NbvPlan_Response * data =
      (tello_autonomy_msgs__srv__NbvPlan_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tello_autonomy_msgs__srv__NbvPlan_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tello_autonomy_msgs__srv__NbvPlan_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tello_autonomy_msgs__srv__NbvPlan_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
