...
#include "tello_autonomy_msgs/srv/detail/nbv_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tello_autonomy_msgs::srv::NbvPlan_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tello_autonomy_msgs::srv::NbvPlan_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tello_autonomy_msgs::srv::NbvPlan_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NbvPlan_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tello_autonomy_msgs::srv::NbvPlan_Request *>(
...
static size_t _NbvPlan_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NbvPlan_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NbvPlan_Request__callbacks = {
...
static rosidl_message_type_support_t _NbvPlan_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NbvPlan_Request__callbacks,
...
{
  return &tello_autonomy_msgs::srv::typesupport_fastrtps_cpp::_NbvPlan_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tello_autonomy_msgs::srv::NbvPlan_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tello_autonomy_msgs::srv::NbvPlan_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tello_autonomy_msgs::srv::NbvPlan_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NbvPlan_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tello_autonomy_msgs::srv::NbvPlan_Response *>(
...
static size_t _NbvPlan_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NbvPlan_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NbvPlan_Response__callbacks = {
  "tello_autonomy_msgs::srv",
  "NbvPlan_Response",
...
static rosidl_message_type_support_t _NbvPlan_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NbvPlan_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &tello_autonomy_msgs::srv::typesupport_fastrtps_cpp::_NbvPlan_Response__handle;
}
...
static service_type_support_callbacks_t _NbvPlan__callbacks = {
  "tello_autonomy_msgs::srv",
  "NbvPlan",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_autonomy_msgs, srv, NbvPlan_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_autonomy_msgs, srv, NbvPlan_Response)(),
...
static rosidl_service_type_support_t _NbvPlan__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NbvPlan__callbacks,
...
{
  return &tello_autonomy_msgs::srv::typesupport_fastrtps_cpp::_NbvPlan__handle;
}
